...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("" STREQUAL "ON"))
    set(OPENNI_INCLUDE_DIRS_HINT "")
    get_filename_component(OPENNI_LIBRARY_HINT "" PATH)
  endif(NOT OPENNI_ROOT AND ("" STREQUAL "ON"))
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/usr/OpenDroneMap_v0_3_1/SuperBuild/src/pcl")
...
set(pcl_all_components  common octree io kdtree search surface )
